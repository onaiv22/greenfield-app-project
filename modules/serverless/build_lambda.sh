...
docker exec -it -w /home/docker s3-antivirus-builder yumdownloader -x \*i686 --archlist=x86_64 clamav clamav-lib clamav-update json-c pcre2 libprelude gnutls lib64nettle nettle libxml2 bzip2-libs libtool-ltdl xz-libs 
...
docker exec -it -w /home/docker s3-antivirus-builder /bin/sh -c "rpm2cpio pcre*.rpm | cpio -idmv"
...
docker exec -it -w /home/docker s3-antivirus-builder /bin/sh -c "rpm2cpio libtasn1* | cpio -idmv"
